...
const SANITIZE_CONFIG = {
  ALLOWED_TAGS: ['p', 'br', 'strong', 'em', 'u', 'code', 'pre', 'blockquote', 'ul', 'ol', 'li', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'a', 'img', 'div', 'svg', 'g', 'path', 'rect', 'circle', 'ellipse', 'line', 'text', 'tspan', 'defs', 'marker', 'foreignObject', 'details', 'summary', 'span', 'style', 'polygon', 'button'],
  ALLOWED_ATTR: ['href', 'src', 'alt', 'title', 'target', 'class', 'id', 'data-diagram-id', 'onclick', 'data-fit-mode', 'style', 'width', 'height', 'viewBox', 'xmlns', 'x', 'y', 'dx', 'dy', 'fill', 'stroke', 'stroke-width', 'stroke-dasharray', 'opacity', 'd', 'cx', 'cy', 'r', 'rx', 'ry', 'x1', 'y1', 'x2', 'y2', 'text-anchor', 'dominant-baseline', 'font-family', 'font-size', 'font-weight', 'transform', 'marker-end', 'marker-start', 'refX', 'refY', 'markerWidth', 'markerHeight', 'orient', 'markerUnits', 'patternUnits', 'gradientUnits', 'gradientTransform', 'points'],
